        ...
        <div className="mt-16 flex justify-center">
          <div className="flex flex-wrap justify-center gap-4">
            <div className="animate fade-in" style={{ animationDelay: "0.1s" }}>
              <img src="/flag-usa.png" alt="Inglês" width="40" height="40" className="rounded-full" />
            </div>
            <div className="animate fade-in" style={{ animationDelay: "0.2s" }}>
              <img src="/flag-spain.png" alt="Espanhol" width="40" height="40" className="rounded-full" />
            </div>
            <div className="animate fade-in" style={{ animationDelay: "0.3s" }}>
              <img src="/flag-france.png" alt="Francês" width="40" height="40" className="rounded-full" />
            </div>
            <div className="animate fade-in" style={{ animationDelay: "0.4s" }}>
              <img src="/flag-germany.png" alt="Alemão" width="40" height="40" className="rounded-full" />
            </div>
            <div className="animate fade-in" style={{ animationDelay: "0.5s" }}>
              <img src="/flag-italy.png" alt="Italiano" width="40" height="40" className="rounded-full" />
            </div>
